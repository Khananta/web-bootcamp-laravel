    ...
    <section style="overflow-x: hidden;">
        <div class="row vh-100">
            <div class="col-5 bg-green py-5 px-5 text-center">
                <h1 class="header-login">Login disini dan jadilah <br> bagian dari kami</h1>
                <p class="caption-login">
                    meningkatkan keterampilan Anda di era digitalisasi ini <br> akan sangat membantu dalam berbagai hal.
                </p>

                <img src="{{ asset('frontend/image/register-image.svg') }}" alt="" width="700">
            </div>
            <div class="col-7 py-5 px-5">
                <div class="text-center">
                    <img src="{{ asset('frontend/image/logo.svg') }}" alt="">
                    <h3 class="mt-5 fw-bold">Login</h3>
